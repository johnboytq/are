...
use app\models\EjecucionFaseBuscar;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * EjecucionFaseController implements the CRUD actions for EjecucionFase model.
 */
class EjecucionFaseController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new EjecucionFaseBuscar();
