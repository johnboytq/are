...
/**
 * This is the model class for table "resultados_evaluacion_docente".
 *
 * @property string $id
 ...
 */
class ResultadosEvaluacionDocente extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'resultados_evaluacion_docente';
    }
