...
/**
 * This is the model class for table "gestion_curricular.dimension_opciones_seguimiento_docente".
 *
 * @property string $id
 ...
 */
class DimensionOpcionesSeguimientoDocente extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'gestion_curricular.dimension_opciones_seguimiento_docente';
    }
