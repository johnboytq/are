...
/**
 * This is the model class for table "gestion_curricular.resultados_esperados".
 *
 * @property string $id
 ...
 */
class GestionCurricularResultadosEsperados extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'gestion_curricular.resultados_esperados';
    }
