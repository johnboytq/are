...
/**
 * This is the model class for table "gestion_curricular.productos_esperados".
 *
 * @property string $id
 ...
 */
class GestionCurricularProductosEsperados extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'gestion_curricular.productos_esperados';
    }
