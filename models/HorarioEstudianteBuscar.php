...
/**
 * HorarioEstudianteBuscar represents the model behind the search form of `app\models\HorarioEstudiante`.
 */
class HorarioEstudianteBuscar extends HorarioEstudiante
{
    /**
     * @inheritdoc
     */
