...
/**
 * This is the model class for table "gestion_curricular.dimension_opciones_seguimiento_directivos".
 *
 * @property string $id
 ...
 */
class DimensionOpcionesSeguimientoDirectivos extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'gestion_curricular.dimension_opciones_seguimiento_directivos';
    }
