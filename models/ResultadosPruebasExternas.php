...
/**
 * This is the model class for table "resultados_pruebas_externas".
 *
 * @property string $id
 ...
 */
class ResultadosPruebasExternas extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'resultados_pruebas_externas';
    }
