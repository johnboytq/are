...
/**
 * This is the model class for table "gestion_curricular.justificacion".
 *
 * @property string $id
 ...
 */
class GestionCurricularJustificacion extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'gestion_curricular.justificacion';
    }
    ...
    {
        return [
            [['descripcion_respuesta', 'id_momento', 'estado'], 'required'],
            [['id_momento', 'estado'], 'default', 'value' => null],
            [['id_momento', 'estado'], 'integer'],
            [['descripcion_respuesta'], 'string', 'max' => 800],
